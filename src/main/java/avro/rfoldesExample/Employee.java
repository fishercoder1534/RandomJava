 ...
 * Broken!!
 *
 * I copied this example from https://github.com/rfoldes/Avro-Test, but it throws NPE, so I filed an issue here: https://github.com/rfoldes/Avro-Test/issues/1
 */
public class Employee {
    ...
    static {
        try {
            InputStream is = Employee.class.getResourceAsStream("Employee.avsc");
